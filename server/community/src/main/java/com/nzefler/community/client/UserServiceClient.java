...
public class UserServiceClient {
    ...
    public UserRef getUserByEmail(String email) {
        UserResponseDTO dto = restTemplate.getForObject(userServiceUrl + "/auth/email/" + email, UserResponseDTO.class);
        return toUserRef(dto);
    }

    public UserRef getUserById(Long userId) {
        UserResponseDTO dto = restTemplate.getForObject(userServiceUrl + "/auth/id/" + userId, UserResponseDTO.class);
        return toUserRef(dto);
    }
